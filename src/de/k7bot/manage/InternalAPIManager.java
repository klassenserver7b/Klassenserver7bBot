...
import de.k7bot.util.customapis.GitHubAPI;
import de.k7bot.util.customapis.GourmettaInteractions;
import de.k7bot.util.customapis.LernsaxInteractions;
import de.k7bot.util.customapis.Stundenplan24Vplan;
import de.k7bot.util.customapis.VVOInteractions;
...
public class InternalAPIManager {
	...
	public void initializeApis() {
		...
		if (propMgr.isApiEnabled("vplan")) {
			registerAPI(new Stundenplan24Vplan("10b"));
