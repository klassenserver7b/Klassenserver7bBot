...
import de.klassenserver7b.k7bot.logging.listeners.ModerationLoggingListener;
import de.klassenserver7b.k7bot.logging.listeners.ChannelLoggingListener;
import de.klassenserver7b.k7bot.logging.listeners.InviteLoggingListener;
import de.klassenserver7b.k7bot.logging.listeners.MemberLoggingListener;
import de.klassenserver7b.k7bot.logging.listeners.RoleLoggingListener;
...
public class Klassenserver7bbot {
	...
	protected ShardManager buildBot(String token, String canaryToken, int shardc) throws IllegalArgumentException {
		...
		builder.addEventListeners(new RoleLoggingListener());
		builder.addEventListeners(new InviteLoggingListener());
		builder.addEventListeners(new ModerationLoggingListener());
		builder.addEventListeners(new MemberLoggingListener());
		builder.addEventListeners(new ChannelLoggingListener());
